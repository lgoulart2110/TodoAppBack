...
namespace TodoApp.Infra.Database._Common.Extensions
{
    public static class QueryableExtensions
    {
        ...
        private static IEnumerable<OrderByInfo> ParseOrderBy(string orderBy)
        {
            ...
            foreach (var item in items)
            {
                ...
                if (pair.Length > 2) throw new ArgumentException($"Invalid OrderBy string '{item}'. Order By Format: Property1, Property2 ASC, Property3 DESC");

                var propertyName = pair[0].Trim();
                if (string.IsNullOrEmpty(propertyName)) throw new ArgumentException("Invalid Property. Order By Format: Property1, Property2 ASC, Property3 DESC");
